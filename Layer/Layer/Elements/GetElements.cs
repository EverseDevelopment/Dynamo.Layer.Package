...
namespace Elements
{
    public class GetElements
    {
        ...
        public static List<Dictionary<string, object>> GetAllElements(string projectId, string bearerToken)
        {
            ...
            var request = new RestRequest($"https://api.layer.team/projects/{projectId}/elements", Method.Get);
        ...
        public static Dictionary<string, object> GetElementById(string projectId, string elementId, string bearerToken)
        {
            ...
            var request = new RestRequest($"https://api.layer.team/projects/{projectId}/elements/{elementId}", Method.Get);
